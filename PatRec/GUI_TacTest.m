...
% Last Modified by GUIDE v2.5 07-Jul-2021 15:28:00
...
function tb_weights_Callback(hObject, eventdata, handles)
% hObject    handle to tb_weights (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of tb_weights as text
%        str2double(get(hObject,'String')) returns contents of tb_weights as a double


% --- Executes during object creation, after setting all properties.
function tb_weights_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tb_weights (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in cb_weights.
function cb_weights_Callback(hObject, eventdata, handles)
% hObject    handle to cb_weights (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)



% Hint: get(hObject,'Value') returns toggle state of cb_weights

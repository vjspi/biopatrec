...
function [LDA accVset] = DiscriminantAnalysis_v2(dType, trSets, trOuts, vSets, vOuts, mov, movIdx)
...
try
    ...
    LDA = fitcdiscr(trSets, trLables, 'ClassNames', mov);
    class = predict(LDA, vSets); 

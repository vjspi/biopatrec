...
% 20xx-xx-xx / Pontus L?vinger  / Added an alternative for ramp recording
...
armMovements = {
    'Open Hand'; 'Close Hand'; 'Flex Hand'; 'Extend Hand'; 'Pronation'; 'Supination'; 'Pinch Grip'; 'Rest'; 'Fine Grip'; 'Agree'; 'Pointer'; 'Thumb Extend'; 'Thumb Flex'; 'Thumb Abduc'; 'Thumb Adduc'; 'Flex Elbow'; 'Extend Elbow'; 'Index Extend'; 'Index Flex'; 'Middle Extend'; 'Middle Flex'; 'Ring Extend'; 'Ring Flex'; 'Little Extend'; 'Little Flex';};

...
if strcmp(deviceName, 'Thalmic MyoBand') || strcmp(deviceName, 'Thalmic MyoBand (Quat incl. Real-time)') || strcmp(deviceName, 'Thalmic MyoBand (IMU)')
...
deviceNames = {'Thalmic MyoBand (IMU)', 'Thalmic MyoBand (Quat incl. Real-time)','AD2','AD3','MyoAmpF4F1','MyoAmpF4F2','MyoAmpF4F7','MyoAmpF4F7_Shielded','NeuroAmpF8F1','RHA2216','RHA2132','ADS1299','ADS_BP','Thalmic MyoBand'};
